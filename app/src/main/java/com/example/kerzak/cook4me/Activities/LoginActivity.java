...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView.setText(savedName);
        mPasswordView.setText(savedPass);

        rememberName.setChecked(!savedName.isEmpty());
        rememberPass.setChecked(!savedPass.isEmpty());
    ...
    private void setCheckBoxListeners() {
        ...
        rememberName.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
